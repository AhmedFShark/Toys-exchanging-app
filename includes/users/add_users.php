<?php
	...
	function user_exist($mtxt)
	{
		...
		$myquery = "SELECT u_ID FROM users WHERE u_username LIKE '" . $mtxt . "' LIMIT 1";
	...
	if(!user_exist($ausername))
	{
		$query = "INSERT INTO users
		        (
		        	credential, u_username, u_password
		        )
		        VALUES
		        (
		        	'{$acredential}', '{$ausername}', '{$apassword}'
		        )";
